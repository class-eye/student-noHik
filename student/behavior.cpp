...
void Analys_Behavior(vector<vector<Student_Info>>&students_all, vector<vector<Student_Info>>&ID, vector<int>&student_valid, vector<Class_Info> &class_info_all, Mat &image_1080, Mat &image, int &n, int &num_turn_body){
