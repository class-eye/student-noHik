...
int main(){
	...
	string resultdir = "/home/liaowang/student_api_no_Hik/output";

	string imgdir = "/home/liaowang/student_api_no_Hik/inputimg_1080/";

	string output = "/home/liaowang/student_api_no_Hik/output2";
